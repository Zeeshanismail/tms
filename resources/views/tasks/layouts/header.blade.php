...
{{--                <!-- Counter - Messages -->--}}
{{--            <?php--}}
{{--            $user = App\Models\User::role('Estimator')->first();--}}
...
{{--                            <div class="small text-gray-500">{{$notification->data['name']}}</div>--}}
{{--                        </div>--}}
{{--                    </a>--}}
{{--                @empty--}}
...
{{--                            <div class="small text-gray-500">No Notification Found</div>--}}
{{--                        </div>--}}
